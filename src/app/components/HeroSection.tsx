  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-between overflow-hidden pt-28 pb-12 bg-background">
      <div className="max-w-4xl mx-auto w-full px-6 flex flex-col items-center text-center relative z-10 flex-grow justify-center">
        <div className="animate-fadeInUp w-full max-w-4xl mx-auto" style={{ animationDelay: '0.1s' }}>
          ...
          <h1 className="font-display text-[4.5rem] sm:text-[5.5rem] md:text-[6.5rem] font-bold leading-[0.95] tracking-tight mb-10 text-center">
            <span className="flex justify-center items-center gap-3 md:gap-5 flex-wrap">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#1E88E5] to-[#8C7BFF] pb-1">Mostaque</span>
            </span>
          ...
          <div className="text-[1.1rem] md:text-[1.25rem] text-black dark:text-white flex flex-col gap-5 max-w-4xl mx-auto mb-14 text-center tracking-wide">
            <p className="font-extrabold text-[1.2rem] md:text-[1.35rem]">Director cum Founder, Algoguido Technologies Pvt. Ltd.</p>
            <p className="text-gray-800 dark:text-gray-200 font-medium">Pursuing Post-Doctoral Fellowship, Eudoxia Research University, USA</p>
            <p className="text-gray-800 dark:text-gray-200 font-medium">Principal Data Scientist Instructor, upGrad Education</p>
            <p className="text-gray-800 dark:text-gray-200 font-medium">PhD in Computer Science, Gauhati University.</p>
            <p className="text-gray-800 dark:text-gray-200 font-medium">Dedicated Researcher in AI, Deep Learning &amp; Network Security</p>
          </div>
